            ...
            <div class='box box-info'>
                ...
                <div class="box-body">
                    <form role="form" id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
                        ...
                        <button input="button" value="button" type="text" class="btn btn-default">Sakit</button>
                        <a href="<?php echo site_url('presensi/create_action_ijin') ?>" class="btn btn-default">Ijin</a>
                        <a href="<?php echo site_url('presensi/create_action_alpha') ?>" class="btn btn-default">Alpha</a>
